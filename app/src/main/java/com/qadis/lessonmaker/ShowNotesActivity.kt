...
class ShowNotesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.DownloadButton.setOnClickListener {
            val success = saveNoteToInternalStorage(currentLessonId, currentContent)
            if (success) {
                Toast.makeText(this, "Note saved for offline!", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun saveNoteToInternalStorage(lessonId: Int, htmlContent: String): Boolean {
        return try {
